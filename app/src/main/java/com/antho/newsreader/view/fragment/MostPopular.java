 ...
 * {@link MostPopular.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MostPopular#newInstance} factory method to
...
public class MostPopular extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        model.getNews("MostPopular").observe(this, new Observer<NewsListJsonModel>()
        {
            @Override
